...
global.channelLink = "https://whatsapp.com/channel/0029Vb8WyZH42DcnlWr7Xe2O";
global.ytch = "Prime Xd ";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb8WyZH42DcnlWr7Xe2O'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/IZfo0nYwybcE5ZmDTPX88L?s=cl&p=a&mlu=0&ilr=0`
                }, { quoted: message });
                return;
            }
        }
